...
import xyz.kyngs.librelogin.velocity.integration.protocolize.MapData;
...
public class MapDataPacket extends AbstractPacket {
    ...
    public static final List<ProtocolIdMapping> MAPPINGS = Arrays.asList(
            ...
            rangedIdMapping(768, 768, 0x2d) // 1.21.2 - 1.21.3; Protocolize 2.4.2 ceiling
    );

    /**
     * Highest protocol supported by the bundled Protocolize API and an
     * explicitly verified map packet mapping.
     * Keep this in sync with {@link #MAPPINGS}; unknown packet IDs must not be
     * sent because Protocolize cannot safely infer a map packet layout.
     */
    public static final int MAX_SUPPORTED_PROTOCOL = 768;
